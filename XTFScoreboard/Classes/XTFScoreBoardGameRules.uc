class XTFScoreBoardGameRules extends GameRules;
...
function bool PreventDeath(Pawn Killed, Controller Killer, class<DamageType> DamageType, vector HitLocation)
{
	...
	if	(
			...
			&&	Killer!=none
			&&	XTFPlayerReplicationInfo(Killer.PlayerReplicationInfo)!=none
		)
	{
		++XTFPlayerReplicationInfo(Killer.PlayerReplicationInfo).FPKilled;
	}
	...
	{
		++XTFPlayerReplicationInfo(Killer.PlayerReplicationInfo).SCKilled;
	}
	...
	{
		++XTFPlayerReplicationInfo(Killer.PlayerReplicationInfo).HuskKilled;
	}
